...
![](7.png)  
为**确保结果不受异常值扰动**，FigureIV说明绝大多数情况下“高层政治关联”公司支付的更少。  
考虑到除了“高层政治关联”公司的购买，还有**“高层政治关联”对象的权力**或他们**退休后是否可以继续影响人事任命**的**额外影响**因素，将*PrincelingPurchaseikjt*分别和虚拟变量*PSCMjp*和*Retiredjpt*进行**交互**。（4）至（6）表示**“高层政治关联”公司和政治局常委的联系使价格折扣增加**了17.6%(exp(-0.62)-exp(-0.62-0.396)=0.176)到20.7%(exp(-0.545)-exp(-0.545-0.442)=0.207)。（7）至（9）表示政治局成员退休后，价格折扣并没有减少，说明**退休并不影响权力的持续**。  
为确保估计不受选择性或不实报道的选择偏差影响，进行**两种稳健性检验**。使用两个**小但精确**的子样本进行检验。一个是与周永康及其儿子有联系的不同商业团体，另一个是一家有“高层政治关联”的上市公司在一级土地市场上的土地购买，结果发现折扣估计值几乎和我们之前的估计值一致（Table AII）。
![](8.png)  
